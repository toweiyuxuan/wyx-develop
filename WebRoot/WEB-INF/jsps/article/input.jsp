	...
	<body>
		<div class="public_box">
			<h1 class="title">
				<strong>创建文档</strong>
				<span>
					<a class="button-normal button-search" href="#">文档列表</a>
				</span>
			</h1>
			<div class="tabBox">
				<div class="tabTitle">
					<div class="tabWrap">
						...
						<span class="tabBtn">文档内容</span>
					</div>
				</div>
				<div class="tabBody mb10">
					<div class="bodyLi bodyActive">
						<div class="win-input mb10">
							<span class="input-name"><i class="mustAdd">*</i>文档标题</span>
						...
						<div class="win-input mb10">
							<span class="input-name">文档来源</span>
							<input type="text" class="text-full" placeholder="请输入">
						</div>
						<div class="win-input mb10">
